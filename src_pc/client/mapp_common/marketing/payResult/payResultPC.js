...
import {showLoading, hideLoading} from "mapp_common/utils/loading";
...
const payResultContent = {
    payDefault: {
        ...
        leftFunc: 'afterPay',
        leftBtn: '已完成付款',
        talkContent: `我想payName${ENV.appName}，但是payName失败了，我该怎么办？`,
    },
    renewDefault: {
        header: '温馨提示',
...
class PayResultPC extends Component {
    ...
    */
    problemClick = () => {
        ...
        contactCustomerService(this.filterText(talkContent), null, 'ad');
        // this.onClose();
    }
