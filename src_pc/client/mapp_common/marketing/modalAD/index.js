...
import { AD_TYPE, CONST_PIDS, MARKET_BEACON_CONST, MARKETING_TYPE, MODAL_3DAYFG_PID, MODAL_HUOBEI_PID } from "tradePublic/marketing/constants";
...
class ModalAD extends Component {
    ...
    */
    highAdBeacon = (type) => {
        ...
        try {
            switch (pid){
                case MODAL_3DAYFG_PID[app][from][platform]:
                    level = 'due3days';
                    break;
                case MODAL_HUOBEI_PID[app]['pid'][platform][from]:
                    level = 'hubeiseller';
                    break;
                case CONST_PIDS[app][platform]['high'][from]:
                    level = 'high';
            }
