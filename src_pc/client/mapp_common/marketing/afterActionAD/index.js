...
import { AD_STATE, AD_TYPE, MARKETING_TYPE, MARKET_BEACON_CONST } from "tradePublic/marketing/constants";
...
class AfterActionAD extends Component {
    ...
    componentDidMount() {
        if(!isEmpty(this.props.ad)) {
            //事后续费弹窗点击埋点
            marketingBeacon(MARKET_BEACON_CONST.show, this.props.pid, 'afterwards');
        }
    }
    ...
    */
    goLink = (url) => {
        //事后续费弹窗点击埋点
        marketingBeacon(MARKET_BEACON_CONST.click, this.props.pid, 'afterwards');
        this.closeAD();
        goClick({
    ...
    */
    ...
    render () {
        ...
        return (
            isModal ?
                // 事后续费弹窗
                <View className='modal-ad-wrapper after-action-modal'>
                ...
                :
                // 事后续费收起球球
                <View className='after-action-ball'>
