import { defaultSettings_public } from "mapp_common/defaultSettings/public";

export const defaultSettings_trademapp = {
    nickMock: {
        enabled: false,
        nick: '',
        sellerId: '',
    ...
    searchHistoriesMb:[],
    sidWithSendChooseDialog: true,   //导入订单号发货中重新导入文件弹窗开关
    wwRushRateDialog: false, //旺旺催评弹窗开关
    wwRushPayDialog: false, //旺旺催付弹窗开关
    courierDialog: true, //打印快递单，打印完返回开关
    ...defaultSettings_public,
};
